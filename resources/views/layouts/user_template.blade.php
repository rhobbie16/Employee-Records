...
<div class="d-flex">
    ...
    {{-- SIDEBAR --}}
    <div class="d-flex flex-column flex-shrink-0 bg-dark text-white" style="width:240px; height:100vh; position:sticky; top:0; overflow-y:auto;">
        {{-- BRAND --}}
        <div class="p-3 border-bottom border-secondary">
            <div class="d-flex align-items-center gap-2">
                ...
                <div>
                    <div class="fw-bold text-white" style="font-size:15px;">ERMS Pro</div>
                    <div class="text-secondary" style="font-size:11px;">Employee Records</div>
                </div>
            </div>
        </div>
    ...
    <div class="flex-grow-1 d-flex flex-column">
        ...
        <nav class="navbar bg-white border-bottom px-4 py-2">
            <div class="ms-auto d-flex align-items-center gap-3">
                <span class="fw-medium text-dark">{{ session('user') ? session('user')->fullname : 'Guest' }}</span>
